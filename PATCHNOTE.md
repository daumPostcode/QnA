...
### 2019. 7. 22
1. http, https 프로토콜로 제한하던 부분 제거, 기존의 location.protocol로 값을 받더라도 http,https로 제한을 두었지만, 이번 패치로 여러 프로토콜을 받을 수 있도록 수정되었습니다. 다만 기본적으로 웹서비스를 지향하고 있기에 http/https 프로토콜 환경하에서 사용하시는 것을 추천드립니다.
