...
### 2024. 12. 20
1. 주소가 지번-도로명 순으로 도로명주소가 연관주소로 검색이 될때, 'roadnameEnglish' 변수에 잘못된 영문명이 들어가던 현상이 수정되었습니다.
...
### 2021. 8. 3
1. open() 함수의 속성 중에 popupName -> popupKey 로 변경되었습니다. 해당 속성은 팝업창의 중복실행을 방지하는 내부적인 Key값으로 사용되는 옵션인데 명칭이 햇갈리게 되어 있어서 변경하였습니다. legacy를 위해 기존의 옵션명도 사용 가능합니다.
2. open() 함수의 속성에 popupTitle이 추가되었습니다. 해당 속성에 값을 지정하면 팝업창의 상태표시줄에 표시되는 타이틀명을 변경할 수 있습니다.
